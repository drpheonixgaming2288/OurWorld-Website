            ...
            >
              <section class="mb-10 text-center">
                <h2 class="fw-bold mb-5">
                  <span>Executive Leadership</span> <u class="text-primary"></u>
                </h2>
                <div class="row gx-lg-5 mx-auto">
                  <div class="col-lg-4 col-md-12 mb-4 mb-lg-0 mx-auto">
                    <div class="card">
                      ...
                      <div class="card-body">
                        ...
                        <p class="text-muted">My <a rel="me" href="https://mastodon.gamedev.place/@nyxsolis">Mastodon</a></p>
                      </div>
                    </div>
                  </div>
                  <div class="col-lg-4 mb-4 mb-lg-0 mx-auto">
                    <div class="card">
                      ...
                      >
                        <img
                          src="https://github.com/OurWorldMetaverse/imgs/blob/main/Italy.png?raw=true"
                          class="w-100"
                          alt=""
                          aria-controls="#picker-editor"
                        />
                      ...
                      <div class="card-body">
                        <h5 class="fw-bold">Isaiah</h5>
                        <p class="text-muted">
                          Head of 3D Modeling Technologies
                        </p>
                        <p class="text-muted">isaiah@ourworldmetaverse.xyz</p>
                      </div>
                    </div>
                  </div>
                </div>
